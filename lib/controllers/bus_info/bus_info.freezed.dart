...
mixin _$BusInfoState {
  ...
  Map<String, List<String>> get busInfoMap =>
...
abstract class $BusInfoStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<BusInfoModel> busInfoList, Map<String, List<String>> busInfoMap});
}
...
class _$BusInfoStateCopyWithImpl<$Res, $Val extends BusInfoState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      busInfoMap: null == busInfoMap
          ? _value.busInfoMap
          : busInfoMap // ignore: cast_nullable_to_non_nullable
...
class _$BusInfoStateImpl implements _BusInfoState {
  ...
  final Map<String, List<String>> _busInfoMap;
  @override
  @JsonKey()
  Map<String, List<String>> get busInfoMap {
    if (_busInfoMap is EqualUnmodifiableMapView) return _busInfoMap;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_busInfoMap);
  }

  @override
  String toString() {
    return 'BusInfoState(busInfoList: $busInfoList, busInfoMap: $busInfoMap)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._busInfoMap, _busInfoMap));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_busInfoMap));
...
abstract class _BusInfoState implements BusInfoState {
  const factory _BusInfoState(
      ...
      final Map<String, List<String>> busInfoMap}) = _$BusInfoStateImpl;
